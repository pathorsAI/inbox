...
ActiveRecord::Schema[7.2].define(version: 2026_09_12_170559) do
  ...
  create_table "campaign_templates", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id", "name"], name: "index_campaign_templates_on_account_id_and_name", unique: true
    t.index ["account_id"], name: "index_campaign_templates_on_account_id"
  end
  ...
  create_table "channel_email", force: :cascade do |t|
    ...
    t.boolean "newsletter_filter_enabled", default: true, null: false
  ...
  create_table "sender_list_entries", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.integer "list_type", null: false
    t.string "value", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id", "value"], name: "index_sender_list_entries_on_account_id_and_value", unique: true
    t.index ["account_id"], name: "index_sender_list_entries_on_account_id"
  end
  ...
  add_foreign_key "campaign_templates", "accounts"
