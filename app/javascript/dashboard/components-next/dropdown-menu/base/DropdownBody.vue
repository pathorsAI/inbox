...
<template>
  <div class="absolute">
    <ul
      class="text-sm bg-n-alpha-3 backdrop-blur-[100px] border rounded-xl shadow-sm py-2 n-dropdown-body gap-2 grid list-none px-2 reset-base relative animate-in fade-in-0 zoom-in-95 duration-fast ease-out-soft motion-reduce:animate-none"
